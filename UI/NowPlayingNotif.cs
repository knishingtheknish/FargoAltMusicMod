...
namespace knishfargomusic.UI
{
    public class NowPlayingNotif : IInGameNotification
    {
        ...
        public void DrawInGame(SpriteBatch spriteBatch, Vector2 bottomAnchorPosition)
        {
            ...
            Utils.DrawBorderString(color: TerryMusicSystem.TextColor * Opacity, sb: spriteBatch, text: displayText, pos: vector, scale: effectiveScale * 0.9f, anchorx: 1f, anchory: 0.4f);
